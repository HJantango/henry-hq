...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed lg:static inset-y-0 left-0 z-40 w-64 glass-strong flex flex-col transition-transform duration-300 lg:translate-x-0",
      ...
      >
        ...
        <div className="p-4 border-t border-white/[0.06]">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div>
              <p className="text-sm font-medium text-white">Heath</p>
              <p className="text-xs text-dark-400">Wild Octave</p>
            </div>
            <div className="ml-auto w-2 h-2 rounded-full bg-green-500 animate-glow-pulse" />
          </div>
        </div>
      </aside>
    </>
